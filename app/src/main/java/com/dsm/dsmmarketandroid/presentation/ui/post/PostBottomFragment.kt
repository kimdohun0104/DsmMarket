...
import kotlinx.android.synthetic.main.fragment_post_bottom.*
...
class PostBottomFragment : BottomSheetDialogFragment() {
    ...
    ): View? = inflater.inflate(R.layout.fragment_post_bottom, container, false)

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        cl_purchase.setOnClickListener {
            dismiss()
            startActivity<PostPurchaseActivity>()
        }

        cl_rent.setOnClickListener {
            dismiss()
