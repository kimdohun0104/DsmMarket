...
class MyPostPurchaseListAdapter : RecyclerView.Adapter<MyPostPurchaseListAdapter.ViewHolder>() {

    private val listItems = arrayListOf<ProductModel>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_post_product, parent, false))
